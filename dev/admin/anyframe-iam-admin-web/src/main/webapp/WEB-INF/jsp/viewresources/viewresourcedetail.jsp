...
<script type="text/javascript">
	...
	function checkforName() {
		var pop = 0;
		var viewName = document.viewResources.viewName;
	...
	function setViewName(viewName) {
		var textbox1 = document.viewResources.viewName;
		textbox1.value = viewName;
	}
</script>
<style type="text/css">
<!--
...
<form:form commandName="viewResources" method="post"
	...
	<table width="572" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<td class="tdin" width="230">
			
				<div style="display:none">
					<form:input path="viewResourceId" 
					id="viewResourceId" cssClass="ct_input_g"
					cssErrorClass="text medium error" maxlength="50"
					readonly="true" size="30" />&nbsp;<form:errors
					path="viewResourceId" cssClass="error" />
				</div>

				<form:input path="viewName" id="viewName" readonly="true"
				cssClass="ct_input_g" cssErrorClass="text medium error"
				maxlength="50" size="30" onclick="javascript:checkforName();" />&nbsp;<form:errors path="viewName"
				cssClass="error" />
			</td>
			<td class="tdin">	
				<c:if test="${not empty viewResources.viewResourceId}">			
					<table height="19" border="0" cellpadding="0" cellspacing="0">
		                <tr>
		                  ...
		                  <td background="<c:url value='/images/btn/bg_btnsmall.gif'/>" class="smallBtn"><a href="javascript:checkforName();" name="checkName">Check Name</a></td>
		...
		<tr>
			...
			<td bgcolor="#D6D6D6" width="1"></td>
			<td class="tdin" colspan="2" ><form:input path="category" id="category"
				cssClass="ct_input_g" cssErrorClass="text medium error"
		...
		<tr>
			...
			<td bgcolor="#D6D6D6" width="1"></td>
			<td class="tdin" colspan="2" ><form:input path="description" id="description"
				cssClass="ct_input_g" cssErrorClass="text medium error"
		...
		<tr>
			...
			<td bgcolor="#D6D6D6" width="1"></td>
			<td class="tdin" colspan="2" ><form:input path="viewInfo" id="viewInfo"
				cssClass="ct_input_g" cssErrorClass="text medium error"
