...
package org.anyframe.iam.admin.roles.web;
...
public class AnnotationRolesController {
	...
	@Resource(name = "idGenServiceRole")
	private IdGenService idGenServiceRole;
	...
	public String getRoleId(Model model) throws Exception {
		String roleId = idGenServiceRole.getNextStringId();
