package org.anyframe.iam.admin.dataupload.web;
...
import org.anyframe.iam.admin.common.web.IAMDomainValidator;
...
public class AnnotationDataUploadController {
	...
	@Resource(name = "idGenServiceDataUpload")
	private IdGenService idGenServiceDataUpload;
	...
	public String uploadFile(@RequestParam("filedata") MultipartFile file, Model model, HttpSession session) throws Exception{
		...
		String nextFileId = idGenServiceDataUpload.getNextStringId();
