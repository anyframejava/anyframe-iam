...
package org.anyframe.iam.admin.groups.web;
...
public class AnnotationGroupsController {
	...
	@Resource(name = "idGenServiceGroup")
	private IdGenService idGenServiceGroup;
	...
	public String getGroupId(Model model) throws Exception {
		String groupId = idGenServiceGroup.getNextStringId();
