...
package org.anyframe.iam.admin.authorities.dao.impl;
...
public class AuthoritiesDaoHibernateImpl extends
	...
	@SuppressWarnings("unchecked")
	public List<Groups> getGroupList(AuthoritySearchVO authoritySearchVO)
			throws Exception {
		...
		List<Groups> resultList = this.getDynamicHibernateService().findList(
	...
	@SuppressWarnings("unchecked")
	public List<String> getGroupIdList(AuthoritySearchVO authoritySearchVO)
			throws Exception {
		String type = StringUtil.null2str(authoritySearchVO.getType());
		String roleId = StringUtil.null2str(authoritySearchVO.getRoleId());
		Object[] args = new Object[2];
		...
		List<String> resultList = this.getDynamicHibernateService().findList(
