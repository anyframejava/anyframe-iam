...
public interface AuthoritiesDao extends IamGenericDao<Authorities, AuthoritiesId> {
	 ...
	 */
	List<Groups> getGroupList(AuthoritySearchVO authorituSearchVO) throws Exception;
	 ...
	 * @throws Exception fail to get a list
	 */
	List<String> getGroupIdList(AuthoritySearchVO authorituSearchVO) throws Exception;
