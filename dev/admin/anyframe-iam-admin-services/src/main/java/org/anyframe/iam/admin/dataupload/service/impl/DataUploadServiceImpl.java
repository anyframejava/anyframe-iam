package org.anyframe.iam.admin.dataupload.service.impl;
...
import org.anyframe.iam.admin.common.IAMDataBinder;
...
public class DataUploadServiceImpl extends GenericServiceImpl<DataUpload, String> implements DataUploadService{
	...
	private IdGenService IdGenServiceSnapshot;
	...
	public IdGenService getIdGenServiceSnapshot() {
		return IdGenServiceSnapshot;
	}

	public void setIdGenServiceSnapshot(
			IdGenService IdGenServiceSnapshot) {
		this.IdGenServiceSnapshot = IdGenServiceSnapshot;
	}
	...
	public void doSnapshot() throws Exception{
		...
		// File Name, Dir 지정
		String nextId = IdGenServiceSnapshot.getNextStringId();
		...
		String workDate = DateUtil.getCurrentTime("yyyyMMdd");
