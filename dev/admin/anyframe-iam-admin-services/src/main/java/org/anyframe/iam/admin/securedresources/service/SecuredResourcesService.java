...
package org.anyframe.iam.admin.securedresources.service;
...
public interface SecuredResourcesService extends GenericService<SecuredResources, String> {
	...
	Page getUnmappedResourceList(ResourceSearchVO searchVO) throws Exception;
	
	Page getUnmappedAnyRoleList(ResourceSearchVO searchVO) throws Exception;
	...
	List<SecuredResources> save(List<TempSecuredResources> tempResourceList) throws Exception;
}