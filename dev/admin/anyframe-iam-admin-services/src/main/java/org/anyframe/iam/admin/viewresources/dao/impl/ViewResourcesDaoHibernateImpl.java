...
public class ViewResourcesDaoHibernateImpl extends IamGenericDaoHibernate<ViewResource, String> implements
	...
	public Page getUnmappedList(ViewResourceSearchVO viewResourceSearchVO) throws Exception{
		...
		List<ViewResource> resultList = this.getDynamicHibernateService().findList("findUnmappedViewList", args, pageIndex, pageSize);
		Long totalSize = (Long) this.getDynamicHibernateService().find("countUnmappedViewList", args);
