...
import org.anyframe.generic.dao.hibernate.GenericHibernateDao;
 ...
 */
public class IamGenericDaoHibernate<T, PK extends Serializable> extends GenericHibernateDao<T, PK> implements
		IamGenericDao<T, PK> {
