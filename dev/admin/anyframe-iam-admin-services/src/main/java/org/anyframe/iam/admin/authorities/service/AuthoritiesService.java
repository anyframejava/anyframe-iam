...
package org.anyframe.iam.admin.authorities.service;
...
public interface AuthoritiesService extends GenericService<Authorities, AuthoritiesId> {
	 ...
	 */
	List<Groups> getGroupList(AuthoritySearchVO authoritySearchVO) throws Exception;
	 ...
	 * @throws Exception fail to get a list
	 */
	List<String> getGroupIdList(AuthoritySearchVO authoritySearchVO) throws Exception;
