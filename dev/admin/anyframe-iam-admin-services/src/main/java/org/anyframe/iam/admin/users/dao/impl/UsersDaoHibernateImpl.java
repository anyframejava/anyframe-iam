...
package org.anyframe.iam.admin.users.dao.impl;
...
import org.anyframe.iam.admin.users.dao.UsersDao;
...
public class UsersDaoHibernateImpl extends IamGenericDaoHibernate<Users, String> implements UsersDao {
	...
	@SuppressWarnings("unchecked")
	public List<Users> findUserByName(String userName) throws Exception {
		Object[] arg = new Object[1];
		arg[0] = "userName=%" + userName + "%";
		
		List<Users> resultList = this.getDynamicHibernateService().findList("findUserByName", arg); 
