...
package anyframe.iam.admin.securedresourcesroles.web;
...
public class AnnotationSecuredResourcesRolesController {
	...
	public String addView(Model model) throws Exception {
		model.addAttribute("isOracle", jdbcProperties.getProperty("hibernate.dialect", "undefined").contains("Oracle"));
