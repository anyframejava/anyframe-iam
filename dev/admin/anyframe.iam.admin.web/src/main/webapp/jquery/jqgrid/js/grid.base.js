...
$.fn.jqGrid = function( p ) {
	...
	return this.each( function() {
		...
		$(grid.cDiv).append("<table class='Header' cellspacing='0' cellpadding='0' border='1'><tr><td class='HeaderLeft'><img src='"+ts.p.imgpath+"spacer.gif' border='0' /></td><th>"+ts.p.caption+"</th>"+ ((ts.p.hidegrid===true) ? "<td class='HeaderButton'><img src='"+ts.p.imgpath+"up.gif' border='0'/></td>" :"") +"<!--td class='HeaderRight'><img src='"+ts.p.imgpath+"spacer.gif' border='0' /></td--></tr></table>")
