...
jQuery(document).ready( function() {
	$('[name=updateRole]').click( function() {
		...
		parent.updateRole(document.getElementById("roleId").value, document.getElementById("roleName").value, document.getElementById("description").value);
	});
	
	$('[name=deleteRole]').click( function() {
		parent.deleteRole(document.getElementById("roleId").value);
	});
});
//-->
</script>
...
<table width="572" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="tdin">
			<form:input path="roleId" id="roleId" cssClass="ct_input_g" cssErrorClass="text medium error" readonly="${readonly}" maxlength="10" autocomplete="false" />&nbsp;<form:errors path="roleId" />
		</td>
	</tr>		
