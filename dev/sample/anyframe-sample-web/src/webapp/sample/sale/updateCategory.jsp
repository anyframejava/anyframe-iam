...
function fncUpdateCategory() {
	...
	if(FormValidation(document.detailForm) != false) {		
	    document.detailForm.action="<c:url value='/empupdatecategory.do'/>";
...
<form:form name="detailForm" method="POST" enctype="multipart/form-data" commandName="categoryVO">
...
<table width="100%" height="37" border="0" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="93%" class="ct_ttl01"><anyframe:message code="update.category.title"/></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="categoryName" class="ct_input_g" style="width:150px; height:19px" value="${categoryVO.categoryName}" required fieldTitle="Category Name" maxLength="50" minLength="2" char="sn">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<form:select path="useYn" cssClass="ct_input_g" cssStyle="width:80px">
				<option value="Y" <%= ("Y".equals(categoryVO.getUseYn()) ? "selected" : "")%>>Yes</option>
				<option value="N" <%= ("N".equals(categoryVO.getUseYn()) ? "selected" : "")%>>No</option>				
			</form:select>			
		</td>
	</tr>
	<tr>
