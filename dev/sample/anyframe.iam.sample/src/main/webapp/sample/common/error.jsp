	...
	<tr>
		...
		<td background="<c:url value='/sample/images/ct_ttl_img02.gif'/>" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td width="93%" class="ct_ttl01">Ocurred Error!!!</td></tr>
			</table>
		</td>
	...
	<tr>
		<td width="747">
			<table width="370" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="5"><img src="<c:url value='/sample/images/empty.gif'/>" width="1" height="120"></td>
				</tr>
			</table>
		</td>
	</tr>
									...
									<table width="350" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="300"><br/>
												<font color="red">
												<c:choose>
													<c:when test="${exception.message == 'Occured Error'}">
