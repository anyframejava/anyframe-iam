Anyframe IAM, release 1.1.3 (2011.07)
---------------------------------------------------------
http://www.anyframejava.org

1. Anyframe IAM 소개

IAM은 Java EE 기반의 엔터프라이즈 어플리케이션을 위한 보안 솔루션(사용자 인증 및 권한관리)을 제공하는 Identify & Access Management Framework 이다. 

Java EE 기반의 엔터프라이즈 어플리케이션은 사용자 인증 및 권한관리에 대한 다양한 요구사항을 가지고 있으며,
...
1) Anyframe-iam-x.x.x-bin.zip
   ...
   - 기타			: anyframe.iam.admin.web-x.x.x.war, anyframe.iam.sample-x.x.x.war,
   				  Anyframe IAM 소개 및 기본 사항(readme.txt), 버전 별 변경 사항(changelog.txt), Anyframe IAM 라이센스(license.txt)
