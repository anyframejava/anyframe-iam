...
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('addProduct', 'SAMPLE', 'Sales Mgmt.', 'addProduct', '상품 등록 화면', '', 'button', 'Y');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('listProduct', 'SAMPLE', 'Sales Mgmt.', 'listProduct', '상품 목록조회 화면', '', 'button', 'Y');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('listCategory', 'SAMPLE', 'Sales Mgmt.', 'listCategory', '카테고리 목록조회 화면', '', 'button', 'N');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('updateCategory', 'SAMPLE', 'Sales Mgmt.', 'updateCategory', '카테고리 수정 화면', '', 'button', 'Y');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('listTransaction', 'SAMPLE', 'Purchase Mgmt.', 'listTransaction', '거래 목록조회 화면', '', 'button', 'Y');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('listUser', 'SAMPLE', 'User Mgmt.', 'listUser', '사용자 목록조회 화면', '', 'button', 'Y');
insert into view_resources(view_resource_id, system_name, category, view_name, description, view_info, view_type, visible) values ('updateUser', 'SAMPLE', 'User Mgmt.', 'updateUser', '사용자 수정 화면', '', 'button', 'Y');
